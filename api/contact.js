            ...
            <tr><td align="center">
              <table width="100%" style="max-width:580px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    ...
                    <tr>
                      ...
                      <td style="padding:12px 0;border-bottom:1px solid #f0f0f0;font-size:14px;">
                        <a href="tel:${dialPhone}" style="color:#14B2CA;text-decoration:none;font-weight:600;">${phone}</a>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td style="padding:12px 0;border-bottom:1px solid #f0f0f0;font-size:14px;color:#111;">
                        ${email ? `<a href="mailto:${email}" style="color:#14B2CA;text-decoration:none;">${email}</a>` : '—'}
                      </td>
                    </tr>
                    <tr>
                ...
                <tr><td style="padding:0 36px 32px;">
                  <a href="tel:${dialPhone}" style="display:inline-block;padding:14px 28px;background:#14B2CA;color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;border-radius:8px;">
                    Call ${firstName} Back
                  </a>
                </td></tr>
                ...
                <tr><td style="background:#f9f9f9;padding:20px 36px;border-top:1px solid #eee;">
                  <p style="margin:0;font-size:11px;color:#999;">
                    Submitted via orlandolifestyledentistry.com &nbsp;·&nbsp; ${timestamp} ET
                  </p>
                </td></tr>
