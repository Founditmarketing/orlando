            ...
            <div className="cf">
              {submitted ? (
                ...
                <div>
                  ...
                  <div className="hipaa"><Shield/> Your information is protected under HIPAA privacy regulations</div>
                </div>
              )}
            </div>
            <div className="ci">
      ...
      <footer className="ftr">
        <div className="ftr-in">
          ...
          <div className="ftr-links">
            <a href="#services">Services</a><a href="#pricing">Pricing</a><a href="#doctor">Dr. Mike</a><a href="#">Privacy Policy</a>
          </div>
