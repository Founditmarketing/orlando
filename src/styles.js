...
.ftr-in{max-width:var(--mw);margin:0 auto;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:20px}
.ftr-logo-img{height:36px;width:auto;opacity:0.75}
.ftr-copy{font-size:12px;color:var(--t3);margin-top:4px}
